...
def get_args_parser():
    ...
    parser.add_argument('--dataset', default='FF++',
                        help='choose from [FF++, DFD, CelebDFv1, CelebDFv2, DFDC, DFDCP, WildDeepfake]')
...
if __name__ == '__main__':
    ...
    if args.dataset == 'FF++':
        ...
        # VGGFace2:
        for i, path in enumerate(cfg.VGGFace2_path_for_parsing):
            face_parsing(face_ds_path=path, parsing_result_path=cfg.VGGFace2_parse_ds_path, save_vis_ps=False)
