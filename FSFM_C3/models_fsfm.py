...
class TargetEncoderViT(nn.Module):
    """ Target networks in FSFM-C3: Target Encoder; Target Rep Decoder; Target projector;
...
def vit_target_encoder(model):
    if model == 'fsfm_vit_small_patch16':
        return TargetEncoderViT(
            patch_size=16, embed_dim=384, depth=12, num_heads=12,
            rep_decoder_embed_dim=384, rep_decoder_depth=2, rep_decoder_num_heads=16,
